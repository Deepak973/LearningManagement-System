    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between">
            <div class="top-menu d-flex align-items-center ">
                ...
                Welcome Trainer - {{session('user')->username}}{{-- <button type="button" id="navbar-fullscreen" class="nav-link"><i class="ik ik-maximize"></i></button> --}}
            </div>
            <div class="top-menu d-flex align-items-center d-none">
                ...
                <div class="dropdown">
                    <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <img class="avatar" src="{{ asset(session('user')->profile_pic) }}" alt=""></a>
