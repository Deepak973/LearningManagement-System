            ...
            <div class="card-body">
                <div class="dt-responsive">
                    <div id="simpletable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <div class="row">
                            <div class="col-md-6">
                                <h4><strong>Today's Trainings</strong></h4>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div id="simpletable_filter" class="dataTables_filter">
                                    <a href="{{ route('trainingschedules.create') }}" class="btn btn-primary">
                                        <i class="ik ik-plus"></i>Schedule Training
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        @if($todaystrainings->count() > 0)
                            <table id="simpletable" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="simpletable_info">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($todaystrainings as $index => $ts)
                                  
                                    <tr>
                                        
                                        
                                        <td class="align-top">{{$index+1}}</td>
                                        <td class="align-top">{{$ts->batchname}}</td>
                                        <td class="align-top">{{$ts->name}}</td>
                                        <td class="align-top">{{\Carbon\Carbon::parse($ts->date)->format('Y-m-d')}}</td>
                                        {{-- {{dd($ts->id)}} --}}
                                       
                                        <td class="align-top">
                                            <form action="{{ route('trainingschedules.destroy', [ 'trainingschedule' => $ts->id ]) }}" method="POST">
                                                @csrf
                                                @method("DELETE")
                                                <a href="{{ route('trainingschedules.show', $ts->id) }}">
                        ...
                        @else
                            No Trainings Schedule for Today
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="dt-responsive">
                    <div id="simpletable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <div class="row">
                            <div class="col-md-6">
                                <h4><strong>Upcoming Trainings</strong></h4>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div id="simpletable_filter" class="dataTables_filter">
                                    <a href="{{ route('trainingschedules.create') }}" class="btn btn-primary">
                        ...
                        @if($trainingschedules->count() > 0)
                            <table id="simpletable1" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="simpletable_info">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($trainingschedules as $index => $ts)
                ...
                <div class="dt-responsive">
                    <div id="simpletable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        ...
                        @if($previoustrainings->count() > 0)
                            <table id="simpletable2" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="simpletable_info">
                                <thead>
                                    <th class="sorting_asc" width="5%" tabindex="0" aria-controls="simpletable">Sr.</th>
                                    <th class="sorting" width="5%" tabindex="0" aria-controls="simpletable">Batch Name</th>
                                    <th class="sorting" width="5%" tabindex="0" aria-controls="simpletable">Course Name</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($previoustrainings as $index => $ts)
                        ...
                        @else
                            No Previous Trainings Schedule
                        @endif
                    </div>
                </div>
            </div>
